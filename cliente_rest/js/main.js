...
window.addEventListener('load', function(){
    ...
    ulVehiculoAlta = document.getElementById('ulVehiculoAlta');
    ulVehiculoBaja = document.getElementById('ulVehiculoBaja');
    refrescarLista();
...
function refrescarLista(){
    ...
    ulVehiculoAlta.innerHTML = '<li class="list-group-item">Cargando vehiculos....</li>';
            ...
            vehiculos.forEach( (vehiculo, index) => {
                ...
                if(vehiculo.fecha_baja==null){
                    ...
                    lis += ` <li class="list-group-item">
                        ...
                        ulVehiculoAlta.innerHTML = lis;
                }else{ 
                    estado='Alta';
                    lisBaja += ` <li class="list-group-item">
                            <span class="matricula">${vehiculo.matricula}</span> 
                            <span class="modelo">${vehiculo.modelo}</span>
                            <span class="km"> ${vehiculo.km} KM</span>
                        ...
                        ulVehiculoBaja.innerHTML = lisBaja;
                    }
