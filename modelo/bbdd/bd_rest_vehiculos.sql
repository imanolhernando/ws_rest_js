CREATE DATABASE  IF NOT EXISTS `gv` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `gv`;
-- MySQL dump 10.13  Distrib 8.0.13, for Win64 (x86_64)
--
-- Host: localhost    Database: gv
-- ------------------------------------------------------
...
INSERT INTO `coche` VALUES (1,'3548MKZ','panda',123456,NULL),(2,'9605EFH','corsa',345123,'2018-11-02'),(3,'5674MBD','polo',12345,NULL),(4,'VI000KM','fiesta',234567,'2019-01-02');
...
--
-- Dumping events for database 'gv'
--

--
-- Dumping routines for database 'gv'
--
...
-- Dump completed on 2019-02-06 16:14:49
