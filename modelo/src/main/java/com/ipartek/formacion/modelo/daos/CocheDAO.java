...
public class CocheDAO {
	 ...
	 * Actuliza  un coche
	 * @param coche con datos
	 * @return true en caso de actulizar false en caso contrario
	 * @throws SQLException
	 */
	...
	/**
	 * Borrado logico de un coche
	 * @param id recibe el id del coche
	 * @param op  tipo de operacion
	 * @return true si se da de baja false en caso contrario
	 * @throws SQLException
	 */
	public boolean baja(Long id, boolean op) throws SQLException {
